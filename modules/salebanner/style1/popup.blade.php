<div class="salebanner-component-1 content_header_background_color-2 widgetBackgroundImage" >
    <div class="main-salebanner widgetBgContent">
        <div class="group">
            <div class="content-salebanner-1 widgetTitle">{{$config['title1']}}</div>
            <div class="content-salebanner-2 widgetBigTitle">{{$config['title2']}}</div>
            <div class="content-salebanner-3 widgetDescription">{{$config['content']}}</div>
            <a class="button-send btn btn-effect-default widgetButton widgetBuble" href="{{$config['btn_url']}}">
                <i class="fab fa-telegram-plane" id="bubble-icon"></i>
                <span style="margin-left:2px;" class="widgetBubbleText" id="field-content_bubble_text">{{$config['btn_txt']}}</span>
            </a>
        </div>
    </div>
</div>
