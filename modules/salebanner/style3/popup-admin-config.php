...
$Form->add('style3_title2', 'text', [
    'label' => 'Tiêu đề lớn',
    'after' => '<div class="col-md-6"><div class="form-group">','before' => '</div></div>',
], $config['style3_title2']);
$Form->add('style3_title2_color', 'color', [
    'label' => 'Màu tiêu đề lớn',
    'after' => '<div class="col-md-6"><div class="form-group">','before' => '</div></div>',
], $config['style3_title2_color']);

$Form->add('style3_title3', 'text', [
    'label' => 'Tiêu đề sale',
    'after' => '<div class="col-md-6"><div class="form-group">','before' => '</div></div>',
], $config['style3_title3']);
$Form->add('style3_title3_color', 'color', [
