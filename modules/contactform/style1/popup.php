<div class="js_popup_contactform contactform-style-1">
    <form class="js_popup_contactform__form banner-text formStep1 widgetBgRight">
        ...
        <h1 class="banner-title widgetTitle"><?php echo $config['title1'];?></h1>
        <p class="banner-des widgetDescription widgetDes"><?php echo $config['content'];?></p>
        ...
        <?php } ?>
        <button type="submit" class="banner-button widgetButton className"><?php echo $config['btn_txt'];?></button>
    </form>
...
<style>
    ...
    .contactform-style-1 .banner-images-3 {
        ...
        background: url('<?php echo Template::imgLink($config['popup_bg']);?>') center right no-repeat;
        background-size: cover;
    }
