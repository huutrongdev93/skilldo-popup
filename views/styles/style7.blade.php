<div class="salebanner-component-7 widgetBg">
    <div class="main-salebanner widgetBackgroundImage">
        <div class="group">
            <div class="widgetTitle"><div>{{$config['title1']}}</div></div>
            <div class="widgetBigTitle">{{$config['title2']}}</div>
            <div class="widgetDescription">{{$config['content']}}</div>
            <a class="btn widgetButton" href="{{$config['btn_url']}}" target="_top">{{$config['btn_txt']}}</a>
        </div>
    </div>
</div>
<style>
    ...
    .salebanner-component-7  .widgetButton {
        ...
        color: {{$config['btn_color']}}!important;
        background-color: {{$config['btn_bg']}}!important;
    }
