<div class="js_popup_contact_form contactform-style-1">
    <div class="js_popup_contactform__form banner-text formStep1 widgetBgRight">
...
<style>
    ...
    .contactform-style-1 .form-control {
        background: #eee;
        padding: 10px;
        display: block;
        font-size: 16px;
